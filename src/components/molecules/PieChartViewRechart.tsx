...
const renderCustomizedLabel = (props:any) => {
	...
	return (
		<g>
			...
			<text x={xCountLabel} y={yCountLabel} fill="black" textAnchor={'middle'} dominantBaseline="central">{value}</text>
			<text x={ex + (cos >= 0 ? 1 : -1) * 12} y={ey} fill="black" textAnchor={'middle'} dominantBaseline="central">{value}</text>
		</g>
	);
};
export const PieChartViewRechart: FunctionComponent<IProps> = props => {
	return (
...
export default PieChartViewRechart
