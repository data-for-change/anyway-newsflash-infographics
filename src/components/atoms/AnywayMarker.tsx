...
//save code for using with new  COLOR ICONS
...
const AnywayMarker: FC<IProps> = ({ markerdata }) => {
  ...
  return (
    <Marker position={lPoint} icon={MapIcon.AccidentIcon()}>
      {
        <Popup>
            <div>
...
//   if (severity === 'קלה') return YELLOW_ICON;
//   else if (severity === 'קשה') return ORANGE_ICON;
//   // (severity === "קטלנית")
